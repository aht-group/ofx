...
// Generated on: 2009.02.22 at 04:51:18 PM CET 
//
...
@XmlRootElement(name = "producibleEntities")
public class ProducibleEntities {

    protected List<ProducibleEntities.File> file;
    @XmlAttribute
     ...
     * {@link ProducibleEntities.File }
     * 
     * 
     */
    public List<ProducibleEntities.File> getFile() {
        if (file == null) {
            file = new ArrayList<ProducibleEntities.File>();
        }
        return this.file;
    }
