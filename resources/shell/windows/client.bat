...
@echo ======================================
@echo openFuXML Produktionssystem for Windows
@echo ======================================
...
@set ANT_HOME=%FUXML_DIR%\lib\apache-ant-@@@ant-version@@@
@set classpath=%FUXML_DIR%\lib\saxon-@@@saxon-version@@@.jar;%JAVAJDK%\lib;%FUXML_DIR%\lib\;%ANT_HOME%\lib\ant.jar;%ANT_HOME%\lib\ant-launcher.jar;%FUXML_DIR%\lib\openFuXML-@@@openfuxml-version@@@s.jar;%classpath%
...
rem @echo Windows convert.exe wurde wieder hergestellt
