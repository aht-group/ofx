package org.openfuxml.renderer.markdown.table;
...
import org.openfuxml.renderer.markdown.AbstractOfxMdRenderer;
import org.openfuxml.renderer.text.table.TextCellRenderer;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

public class MdTableRenderer extends AbstractOfxMdRenderer implements OfxTextRenderer
{	
	final static Logger logger = LoggerFactory.getLogger(MdTableRenderer.class);
	...
	public MdTableRenderer(ConfigurationProvider cp)
	{
		super(cp);
