...
public class HtmlFontUtil
{
	...
	public static String fontSize(Font font)
	{
		...
		if(Objects.nonNull(font.getRelativeSize()))
		{
			...
			{
				case -4: fontsize +="50%"; break;
				case -3: fontsize +="63%"; break;
				case -2: fontsize +="75%"; break;
				case -1: fontsize +="88%"; break;
				case 0: fontsize +="100%"; break;
				case 1: fontsize +="120%"; break;
				case 2: fontsize +="140%"; break;
				case 3: fontsize +="160%"; break;
				case 4: fontsize +="180%"; break;
				case 5: fontsize +="200%"; break;
			}
		}
		return fontsize;
	}
